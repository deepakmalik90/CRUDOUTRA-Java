...
public class Constant 
{
    ...
    public static final String ERROR_401                =   "Wrong Credentials";
    public static final String ERROR_400                =   "Invalid JSON";
    public static final String ERROR_403                =   "Permisson Denied";
    ...
    static 
    {
        ...
        ERROR_RESPONSE.put(STATUS_401, "{\"error\":\""+ERROR_401+"\"}");
        ERROR_RESPONSE.put(STATUS_403, "{\"error\":\""+ERROR_403+"\"}");
